...
EXPOSE 8080
RUN apt-get update && apt-get install -y libldap2-dev libkrb5-dev nmap inetutils-ping net-tools libpng-dev libxml2-dev libxslt1-dev libcurl4-openssl-dev zip unzip git libfreetype6-dev libjpeg62-turbo-dev libpng-dev libpq-dev && rm -r /var/lib/apt/lists/*
RUN a2enmod rewrite
